...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Indicator
      ...
      className={cn(
        "top-auto z-50 flex h-1.5 items-end justify-center overflow-hidden data-[state=hidden]:opacity-0 duration-150 ease-in data-[state=visible]:animate-in data-[state=visible]:fade-in data-[state=visible]:slide-in-from-top-1",
        className
      )}
      {...props}
    >
      <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-border md:top-[50%] md:h-2.5 md:w-2.5" />
    </NavigationMenuPrimitive.Indicator>
  )
}
